# EBA Aula 08: Regressão e ANOVA 2 Fatores


Nesta aula você poderá ver na prática como utilizamos a ANOVA 2 fatores em nossos projetos de Análise de Dados e Ciência de dados.
...
```bash
git clone https://github.com/EbaPed/EBA-aula08-ANOVA2Fatores.git
cd EBA-aula08-ANOVA2Fatores
```
